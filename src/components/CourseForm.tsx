        ...
        <form onSubmit={handleSubmit} className="space-y-4" aria-label="Course entry form">
          <div className="space-y-2">
            ...
            <Input
              ...
              maxLength={50}
              className={nameError ? "border-red-400 focus-visible:ring-red-400" : "focus-visible:ring-green-600"}
            />
            {nameError && (
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger 
                id="credit-units" 
                className={creditError ? "border-red-400 focus-visible:ring-red-400" : "focus-visible:ring-green-600"}
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger 
                id="grade" 
                className={gradeError ? "border-red-400 focus-visible:ring-red-400" : "focus-visible:ring-green-600"}
